...
<aside class="alert alert-info">
  ...
  - Par défaut : <em>connexion à un serveur lié avec le <a href="https://docs.mineweb.org/">plugin Bukkit/Spigot/Bungeecord</a>, permet l’utilisation de toutes les fonctionnalités du CMS (boutique, classement factions, vote…)</em> <br>
